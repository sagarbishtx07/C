...
class Third_fragment : Fragment(R.layout.fragment_third_fragment) {
     ...
     */
        ...
        when(c_id){
            0->{
                q1.text=getString(stid[(c_id*4)])
                s1.text=getString(stid[(c_id*4)+1])
                q2.text=getString(stid[(c_id*4)+1])
                s2.text=getString(stid[(c_id*4)+1])
                q3.text=getString(stid[(c_id*4)+1])
                q4.text=getString(stid[(c_id*4)+1])
                q5.text=getString(stid[(c_id*4)+1])
            }
            1->{
                q1.text=getString(stid[(c_id*4)])
                s1.text=getString(stid[(c_id*4)+1])
